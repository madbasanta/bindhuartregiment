                                ...
                                <div class="col-8">
                                    <div class="row">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="soundcloud_url" class="form-control" value="<?= $podcast->soundcloud_url ?>">
                                        ...
                                        <div class="col-6 mb-3">
                                            ...
                                            <input type="text" name="google_url" class="form-control" value="<?= $podcast->google_url ?>">
