...
<?php
$artist = ORM::table('artists')->find($_GET['id']);
if (!$artist) {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" onsubmit="handleCreateBlog(event)">
                            <div class="row g-3">
                                <input type="hidden" name="thumbnail" id="thumbnail" value="<?= $artist->thumbnail ?>">

                                <div class="col-8">
                                    <div class="row">
                                        <div class="col-8 mb-3">
                                            <label for="inputName" class="form-label">Name</label>
                                            <input type="text" name="name" class="form-control" value="<?= $artist->name ?>" id="inputName" onchange="generateSlug(this.value)">
                                        ...
                                        <div class="col-4 mb-3">
                                            ...
                                            <input type="text" name="role" class="form-control" value="<?= $artist->role ?>" id="inputDur">
                                        ...
                                        <div class="col-8 mb-3">
                                            ...
                                            <textarea rows="2" name="shortdesc" class="form-control" id="inputShortdesc"><?= $artist->shortdesc ?></textarea>
                                        ...
                                        <div class="col-4 mb-3">
                                            ...
                                            <input type="text" name="sequence" class="form-control" value="<?= $artist->sequence ?>" id="inputSeq">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <textarea name="description" class="form-control" id="artistDesc"><?= $artist->description ?></textarea>
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="inputSlug" type="text" name="slug" class="form-control" value="<?= $artist->slug ?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div id="thumbDrop">
                                            ...
                                            <div class="dz-preview dz-processing dz-complete dz-image-preview">
                                                <div class="dz-image">
                                                    <img width="100" class="img-fluid" src="/uploads/<?= $artist->thumbnail ?>" data-dz-thumbnail alt="">
                                                    <br>
                                                    <a href="/uploads/<?= $artist->thumbnail ?>">/uploads/<?= $artist->thumbnail ?></a> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        new Dropzone('#thumbDrop', {
            ...
            success(file, response) {
                ...
                if (file.previewElement) {
                    ...
                    file.previewElement.querySelector('.dz-success-mark').innerHTML = `
                        <a href="/uploads/${response.file}">/uploads/${response.file}</a> <i class="bi bi-check-circle-fill text-success"></i>
                    `;
                }
            }
        });
