...
<div class="billboard_1">
    <!--  <div class="side_nav">
                    <a href="#articlemain" class="about_us">Articles</a>
                    <div class="main_dotdotdot">
                    <div class="dotdotdot"></div>
                    <div class="dotdotdot"></div>
                    <div class="dotdotdot"></div>
                    </div>
                    <a href="#aboutus" class="imprint_x">About us</a>
                </div> -->
    <div class="main_billboard" style="/* background-image: url('/images/landing-page.jpg');height:90vh; */">

        <img src="/images/landing-page.jpg" width="1920px" height="1080px" alt="Art as reflection, Bindhu Art Regiment" class="billboardmainimage" style="object-fit: fill;">
    </div>
</div>
<div class="art_as_reflection">
    <h1 class="art_and_literature">
        art as<br>
        reflection
    </h1>
</div>
<div class="cover_arrowdown">
    <div class="animated_arrow_cover">
        ...
        <div class="animated_arrow" onclick="document.querySelector('.footer_wrap').scrollIntoView();">

            <div class="coverarrow">
                <img src="./images/arrowdown.svg" alt="imga" class="arrowimgafter" style="filter: invert();">
                <img src="./images/arrowdown.svg" alt="img" class="arrowimg" style="filter: invert();">
            </div>

        </div>
    </div>
</div>
<div class="billboard_2">
    <div class="nontext">
        <div class="img">
    ...
    <div class="text_bill">
        <p class="explain_naade">
            Bindhu Art regiment (BAR) is a non-profit initiative that works to inspire change &
            question unhealthy dogma and narratives in society through art, films, writings,
            cultural practices and non violent creative campaigns integrating art, media, and
            technology to nurture impact.
            Bindhu art regiment was formed with the principles of artistic expression not to be dimmed by any forces
            but aspire to support creative communities through platforms which can reflect the world around us.
        </p>
        <div class="readmore_wrapper">
            <a href="#whatarewe">
                <div class="rm_billboard2">
                    read more
                </div>
            </a>
        </div>
    ...
    <div class="">
        ...
        <!-- <div class="grid-container">
            <a href="#article1" class="grid-item " style="margin-top: 20px;">
                <div class="collab_1">
                    <div class="img_pro" style="text-align: left;">
                        <img src="/images/IMG_20230926_204723.jpg" style="max-width: 100%;" alt="Filal White Noise , Bindhu Art Regiment" class="collab_1">
                    </div>
                    <div class="collab_text_1">
                        <p class="collab_text_main_1" style="text-align: left;">
                            NO MOVEMENT IN THE GROUND
                            <br><br>
                            <span style="font-weight: normal;">
                                Gandharva village located in Kechana, Jhapa, Indian Border. Kechana village is located
                                at eastern Nepal-
                                jhapa
                                <br>
                                See more...
            ...
            <a href="#article3" class="grid-item " style="margin-top: 20px;">
                <div class="collab_1">
                    <div class="img_pro" style="text-align: left;">
                        <img src="./images/fill-the-space.png" style="max-width: 100%;" alt="Wahuima , Bindhu Art Regiment" class="collab_2">
                    </div>
                    <div class="collab_text_2">
                        <p class="collab_text_main_2" style="text-align: left;">
                            FILL THE SPACE.. an open call for artist in jhapa
                            <br><br>
                            <span style="font-weight: normal;">
                                We have come to jhapa to meet and discuss, share and receive collective insights on how
                                we can together
                                work
                                <br>
                                See more...
            ...
            <a href="#article2" class="grid-item " style="margin-top: 20px;">
                <div class="collab_1">
                    <div class="img_pro" style="text-align: left;">
                        <img src="./images/WAHUIMA-poster.jpg" style="max-width: 100%;" alt="Wahuima , Bindhu Art Regiment" class="collab_2">
                    </div>
                    <div class="collab_text_2">
                        <p class="collab_text_main_2" style="text-align: left;">
                            WAHUIMA - the return of home
                            <br><br>
                            <span style="font-weight: normal;">
                                The core theme of the project is to help artists mix different textures of tribal
                                instruments, poetry
                                and
                                <br>
                                See more...
...
<div class="" style="max-width: 1185px;margin: 50px auto;">
    <div class="recents">
        <button class="cta">
            <span class="hover-underline-animation">RECENTS</span>
            <svg viewBox="0 0 46 16" height="10" width="30" xmlns="http://www.w3.org/2000/svg" id="arrow-horizontal">
                <path transform="translate(30)" fill="black" d="M8,0,6.545,1.455l5.506,5.506H-30V9.039H12.052L6.545,14.545,8,16l8-8Z" data-name="Path 10" id="Path_10">
                </path>
            </svg>
