	...
	<div class="foreground">
		...
		<div id="content">
			<div class="collaboration_container">
				<div class="project_billboard_1">
					<div class="billboard_main">
						<div class="main_billboard_text">
							<p class="f_n_1">find our Projects and works</p>
						</div>
					</div>
				</div>
			</div>
			<div class="words">
				<div class="words">
					<p>
						We love to empower creative culture to support emerging and professional creators and visionaries. Organise and
						facilitate collaborative workshops for artists with discourses from expertise to celebrate and share creative culture.
						We serve artists as a platform to showcase their work through different live events.
					</p>
				</div>
			</div>
