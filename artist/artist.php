...
<head>
    ...
    <title>Bindhu Art Regiment</title>
</head>
<script>
...
<?php
$artists = ORM::table('artists')->select('id', 'slug', 'name', 'shortdesc', 'thumbnail', 'role')->orderBy('sequence')->get();
?>
...
<body>
    <div class="foreground">
        ...
        <div id="content">
            <div class="artist_profile_body">
                <div class="main_artist_billboard">
                    <h1>artist profile</h1>
                </div>
                <div class="artist_profile_body_info">
                    <p>

                        Welcome to our artist profile page, where we proudly showcase the remarkable talents we've had the privilege to collaborate with and work together. <br><br>

                        Through our artistic endeavors, we've had the pleasure of collaborating with visionary artists. Our artist profile page serves as a testament to the power of collaboration and the beauty that emerges when talents intertwine. <br>

                        Discover the captivating world of Bindhu Art Regiment artists and be inspired by the collective power of art.<br><br>
                    </p>
                </div>
                <div class="artists">
                    ...
                    <div class="artist_content">
                        <div class="artist_image">
                            <img src="/uploads/<?= $artist->thumbnail ?>" width="300px" alt="<?= $artist->name ?>">
                        </div>
                        ...
                        <div class="artist_read_more_wrapper">
