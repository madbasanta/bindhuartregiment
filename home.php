...
<body>
    <div class="foreground">
        <nav>
            <nav class="navbar_cover">
                <div class="section_1">
                    <div class="main_logo">
                        <a href="/">
                            <img src="./images/logo/mainlogo.png" width="215.82px" height="100px" class="BAR_logo"
                                alt="Bindhu Art Regiment" style="filter: invert();">
                        </a>
                    </div>
                </div>
                <div class="section_2">
        ...
        <div id="content">
            <?php include base_path('home/index.php') ?>
        </div>
                    ...
                    <div class="f_s_2">
                        ...
                        <form action="/" method="post">
                            <div class="wave-group-f">
                                <input required="" type="email" class="input-f" name="subscriber_email"
                    ...
                    <div class="socials">
                        ...
                        <div class="images_social">
                            <a href="https://www.facebook.com/100093439433363" class="facebook" target="_blank">
                                <img src="./images/images/facebook.svg" width="45px" height="45px" alt="fbimg"
                                    class="fbimg">
                            </a>
                            <a href="https://www.instagram.com/bindhuart.reg/" class="instagram" target="_blank">
                                <img src="./images/images/instagram.svg" width="45px" height="45px" alt="instaimg"
                                    class="instaimg">
                            </a>
                            <a href="https://twitter.com" class="twitter" target="_blank">
                                <img src="./images/images/twitter.svg" width="45px" height="45px" alt="tweetimg"
                                    class="tweetimg">
                            </a>
                        </div>
    ...
    <!-- <script src="/js/router.js?v=1.0.5"></script> -->
